...
每把武器分别保存 8 级火力和 8 级弹量，两条强化共用当前总等级的下一档价格。八个枪段的第二/第三个 Boss 最低总强化依次为 `1/2、1/3、2/4、3/6、4/8、4/8、4/8、4/8`。

基准路线只购买前沿 Boss 所需强化，并在缺钱时回刷本枪段已通关的最高 Boss。W2～W8 购买前的额外段末回刷为 `1、1、2、2、3、3、4` 场；完整路线共 71 场，模型首通约 26～30 分钟。完整固定表位于 `Assets/BossClicker/Data/PrototypeBalance.asset`，策划依据见 [v4.1 制作方案](tasks/v4.1-hold-fire-balance-plan.md)。
